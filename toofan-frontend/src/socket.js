...
// Connects to EC2 backend via Vercel proxy (/socket.io)
// ─────────────────────────────────────────────────────────────
...
// ── Driver helpers ────────────────────────────────────────────
export function driverGoOnline() { socket?.emit("driver_online"); }
export function driverGoOffline() { socket?.emit("driver_offline"); }
...
export function driverAcceptJob(orderId) { socket?.emit("accept_job", { orderId }); }
export function driverRejectJob(orderId) { socket?.emit("reject_job", { orderId }); }
...
// ── Customer helpers ──────────────────────────────────────────
export function customerTrackOrder(orderId) { socket?.emit("track_order", { orderId }); }
